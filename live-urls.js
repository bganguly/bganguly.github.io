window._liveUrls = {
  ...
  nextjs:     { fe: 'rao',                                                                              be: 'rao' },
  nlsql:      { fe: 'https://natural-language-to-llm-query-comparison.vercel.app/nl-to-sql/' },
  phi:        { fe: 'rao',                                                                              be: 'rao',  ex: 'rao' },
  serverless: { fe: 'https://d3nbn0s3ea4m39.cloudfront.net',                                           be: 'https://d3nbn0s3ea4m39.cloudfront.net/api-explorer.html' },
  fargate:    { fe: 'https://d3gn54w27kjodk.cloudfront.net',                                           be: 'rao' },
};
